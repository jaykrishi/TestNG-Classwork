...
public class CrmTest {
	...
	By EMAILPASSWORD_LOCATOR = By.xpath("//input[@id='password']");
	By CONFIRM_LOCATOR = By.xpath("//input[@id='cpassword']");
	...
	public void addCustomerTest() {
		...
		driver.findElement(By.xpath("//input[@id='phone']")).sendKeys("3405673455");
		driver.findElement(By.xpath("//input[@id='address']")).sendKeys("123 broad ln");
		...
		selectFromDropdown(TAG_LOCATOR,"adad");
		
		
		selectFromDropdown(CURRENCY_LOCATOR,"USD");
		
		selectFromDropdown(GROUP_LOCATOR,"wdwd");
		
		driver.findElement(EMAILPASSWORD_LOCATOR).sendKeys("abcde34");
		driver.findElement(CONFIRM_LOCATOR).sendKeys("abcde34");
